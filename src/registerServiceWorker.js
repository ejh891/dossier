...
export default function register() {
  if ('serviceWorker' in navigator) {
    ...
    window.addEventListener('load', () => {
      // on local, just serve the custom service-worker, in prod we generate a service-worker and merge in our custom one
      const swUrl = isLocalhost ? `${process.env.PUBLIC_URL}/sw.js` : `${process.env.PUBLIC_URL}/service-worker.js`;
